...
export default function Welcome() {
    ...
    return (
        <div className="overflow-x-hidden bg-black">
            <NavigationBar />
            <h1 className={`px-${paddingSize} text-center pt-6 mb-4 flex text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white`}>
                Welcome.
            </h1>
            <div>
            <p className={`px-${paddingSize} flex justify-center`}>
                ...
                <br />
            <h2 className={`italic px-${paddingSize} pt-6 mb-4 flex text-1xl font-extrabold leading-none tracking-tight text-gray-900 xsm:text-1xl sm:text-1xl md:text-2xl lg:text-3xl dark:text-white`}>
